...
(function () {
    ...
    function getTemplates(projectName) {
        ...
        let defaultTpls = [
            { id: 'tpl_std', name: '💬 Пример', text: 'Предлагаю обратить внимание на наш эксклюзивный {имя}! При пополнении всего от {деп} RUB у вас появляется шикарный шанс забрать {награда1} и целых {фс} фриспинов в хитовых слотах от топового провайдера Pragmatic Play.' }
        ];
