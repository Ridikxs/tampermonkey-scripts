...
(function () {
    ...
    function updateCashbackDisplay() {
        ...
        const status = realWithoutLive >= 0
            ? 'Клиент в минусе по ставкам за выбранный период'
            : 'Клиент в плюсе по ставкам за выбранный период';
        ...
        `;
        log('✅ Готово! Отображение обновлено.');
    }
    ...
    async function fetchCashback(isLive = false) {
        ...
        if (!response.ok) {
            log(`❌ Ошибка запроса: ${response.status}`);
        ...
        if (td7 && td8) {
            ...
            log("⚠️ Не удалось найти данные ставок.");
            if (isLive) liveCashback = 0;
            else normalCashback = 0;
        }
    ...
    function showConditionsForProject(name) {
        const infoMap = {
            Catcasino: `
                <section class="cat-cb" style="font-family:Inter,Arial,sans-serif;max-width:820px;margin:18px auto;padding:18px;border-radius:10px;
  box-shadow:0 6px 22px rgba(0,0,0,0.08);background:#fff;border:1px solid #eef2f6;">
  ...
  <footer style="margin-top:12px;font-size:13px;color:#475569;">
    🔗 <a href="https://confluence.itdepcat.tech/pages/viewpage.action?pageId=24281530" target="_blank" style="color:#0b79ff;text-decoration:none;"><b>Подробнее → Cat</b></a>
  </footer>
</section>
            `,
            Arkada: `
                <section class="arkada-cb" style="font-family:Inter,Arial,sans-serif;max-width:820px;margin:20px auto;padding:18px;border-radius:10px;
  box-shadow:0 6px 22px rgba(0,0,0,0.08);background:#fff;border:1px solid #eef2f6;">
  <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
  ...
  <div style="font-size:13.5px;color:#0b1220;line-height:1.45;">
    ...
    <p style="margin:12px 0 0 0;font-size:13px;color:#475569;">
      📎 <a href="https://confluence.itdepcat.tech/display/SUPDEP/CashBack+Arkada" target="_blank" style="color:#0b79ff;text-decoration:none;"><b>Подробнее → Confluence</b></a>
    </p>
  </div>
</section>
            `,
            Gama: `
      <section class="cb-card" style="font-family:Inter,Arial,sans-serif;max-width:820px;margin:20px auto;padding:18px;border-radius:10px;
  box-shadow:0 6px 22px rgba(0,0,0,0.08);background:#fff;border:1px solid #eef2f6;">
  ...
  <footer style="margin-top:12px;font-size:13px;color:#475569;">
    <strong>Максимальная ставка для отыгрыша бонуса:</strong> Regular и Pro – <b>5 EUR / 500 RUB</b>; Master – <b>без ограничения</b>.
  </footer>
</section>
      🔗 <a href="https://confluence.itdepcat.tech/display/SUPDEP/Cashback+-+Gama" target="_blank">Подробнее → Gama</a>
            `,
            Daddy: `
                <!-- Новый кешбек — Daddy -->
<section class="daddy-cb" style="font-family:Inter,Arial,sans-serif;max-width:920px;margin:20px auto;padding:20px;border-radius:10px;
  box-shadow:0 8px 30px rgba(2,6,23,0.06);background:#ffffff;border:1px solid #eef2f6;">
  ...
  <div style="display:grid;grid-template-columns:1fr;gap:12px;">
    ...
    <div style="padding:12px;border-radius:10px;background:#fff;border:1px solid #eef2f6;">
      ...
      <div style="margin-top:12px;font-size:13px;color:#475569;">
        <strong>Вейджеры по уровням:</strong> Bronze - <b>x15</b> / Silver - <b>x10</b> / Gold - <b>x5</b> / Diamond - <b>x3</b>
      </div>
    </div>
  </div>
</section>
      🔗 <a href="https://confluence.itdepcat.tech/display/SUPDEP/Cashback+-+Daddy" target="_blank">Подробнее → Daddy</a>
            `,
            Mers: `
      ...
      🔗 <a href="https://confluence.itdepcat.tech/display/SUPDEP/Cashback+-+Mers" target="_blank">Подробнее → Mers</a>
            `,
            Kent: `
                <section class="cb-full" style="font-family:Inter,Arial,sans-serif;max-width:920px;margin:18px auto;padding:18px;border-radius:10px;
  background:#fff;border:1px solid #eef2f6;box-shadow:0 8px 28px rgba(2,6,23,0.06);color:#0b1220;">
  ...
  <footer style="margin-top:12px;font-size:13px;color:#475569;">
    <b>Примечание</b>: Деление процентов по чистому проигрышу применяется только для уровней 2–5. Для уровней 6–10 процент фиксирован и указан отдельно.
  </footer>
</section>
      🔗 <a href="https://confluence.itdepcat.tech/display/SUPDEP/CashBack+-+Kent+Casino" target="_blank">Подробнее → Kent</a>
            `,
            R7: `
                <section class="cb-15lvls" style="font-family:Inter,Arial,sans-serif;max-width:960px;margin:18px auto;padding:18px;border-radius:10px;
  background:#fff;border:1px solid #eef2f6;box-shadow:0 8px 28px rgba(2,6,23,0.06);color:#0b1220;">
  ...
  <div style="display:grid;gap:12px;">
    ...
    <div style="padding:12px;border-radius:8px;background:#f8fafc;border:1px solid #eef2f6;">
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;">
        <b>Cashback lvl 2</b><br>
        Процент начисления: <b>2%</b><br>
        Вейджер: <b>x5</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>2000 EUR / 200 000 RUB</b>
      </div>
      <hr style="border:none;border-top:1px dashed #eef2f6;margin:10px 0;">
      <div style="font-size:13px;line-height:1.45;color:#0b1220;">
        <b>Cashback lvl 3</b><br>
        Процент начисления: <b>3%</b><br>
        Вейджер: <b>x5</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>2000 EUR / 200 000 RUB</b>
      </div>
      <hr style="border:none;border-top:1px dashed #eef2f6;margin:10px 0;">
      <div style="font-size:13px;line-height:1.45;color:#0b1220;">
        <b>Cashback lvl 4</b><br>
        Процент начисления: <b>4%</b><br>
        Вейджер: <b>x5</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>2000 EUR / 200 000 RUB</b>
      </div>
    ...
    <div style="padding:12px;border-radius:8px;background:#fff;border:1px solid #eef2f6;">
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 5</b><br>
        Процент начисления: <b>5%</b><br>
        Вейджер: <b>x4</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>2000 EUR / 200 000 RUB</b>
      </div>
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 6</b><br>
        Процент начисления: <b>6%</b><br>
        Вейджер: <b>x4</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>5000 EUR / 500 000 RUB</b>
      </div>

      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 7</b><br>
        Процент начисления: <b>7%</b><br>
        Вейджер: <b>x4</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>5000 EUR / 500 000 RUB</b>
      </div>
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;">
        <b>Cashback lvl 8</b><br>
        Процент начисления: <b>8%</b><br>
        Вейджер: <b>x4</b><br>
        Ограничение по максимальному выигрышу: <b>x5</b><br>
        Максимальный размер кешбека: <b>5000 EUR / 500 000 RUB</b>
      </div>
    ...
    <div style="padding:12px;border-radius:8px;background:#f8fafc;border:1px solid #eef2f6;">
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 9</b><br>
        Процент начисления: <b>9%</b><br>
        Вейджер: <b>x3</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер кешбека: <b>5000 EUR / 500 000 RUB</b>
      </div>

      <div style="font-size:13px;line-height:1.45;color:#0b1220;">
        <b>Cashback lvl 10</b><br>
        Процент начисления: <b>10%</b><br>
        Вейджер: <b>x3</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер кешбека: <b>5000 EUR / 500 000 RUB</b>
      </div>
    ...
    <div style="padding:12px;border-radius:8px;background:#fff;border:1px solid #eef2f6;">
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 11</b><br>
        Процент начисления: <b>11%</b><br>
        Вейджер: <b>x3</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер суммы Cashback: <b>неограничен</b>
      </div>

      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 12</b><br>
        Процент начисления: <b>12%</b><br>
        Вейджер: <b>x3</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер суммы Cashback: <b>неограничен</b>
      </div>
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 13</b><br>
        Процент начисления: <b>13%</b><br>
        Вейджер: <b>x2</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер суммы Cashback: <b>неограничен</b>
      </div>
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;margin-bottom:10px;">
        <b>Cashback lvl 14</b><br>
        Процент начисления: <b>14%</b><br>
        Вейджер: <b>x2</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер суммы Cashback: <b>неограничен</b>
      </div>
      ...
      <div style="font-size:13px;line-height:1.45;color:#0b1220;">
        <b>Cashback lvl 15</b><br>
        Процент начисления: <b>20%</b><br>
        Вейджер: <b>x1</b><br>
        Ограничение по максимальному выигрышу: <b>x3</b><br>
        Максимальный размер суммы Cashback: <b>неограничен</b>
      </div>
  ...
  <footer style="margin-top:12px;font-size:13px;color:#475569;">
    <b>Примечание:</b> "Ограничение по максимальному выигрышу" означает множитель Max Win, применяемый при расчёте максимальной суммы, которую игрок может вывести после отыгрыша кешбека.
  </footer>
</section>
      🔗 <a href="https://confluence.itdepcat.tech/display/SUPDEP/CashBack+R7" target="_blank">Подробнее → R7</a>
            `,
            Kometa: `
                <section class="cb-structured" style="font-family:Inter,Arial,sans-serif;max-width:980px;margin:18px auto;padding:18px;border-radius:10px;
  background:#fff;border:1px solid #eef2f6;box-shadow:0 8px 28px rgba(2,6,23,0.06);color:#0b1220;">
  <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
  ...
  <div style="padding:12px;border-radius:8px;background:#f8fafc;border:1px solid #eef2f6;margin-bottom:12px;">
    ...
    <div style="font-size:13px;line-height:1.45;margin-bottom:10px;">
      <b>Cashback lvl 6</b><br>
      Процент начисления: <b>11%</b> — от любой суммы чистого проигрыша<br>
      Вейджер: <b>x3</b><br>
      Ограничение по максимальному выигрышу: <b>x7</b>
    </div>

    <div style="font-size:13px;line-height:1.45;margin-bottom:10px;">
      <b>Cashback lvl 7</b><br>
      Процент начисления: <b>12%</b> — от любой суммы чистого проигрыша<br>
      Вейджер: <b>x3</b><br>
      Ограничение по максимальному выигрышу: <b>x7</b>
    </div>
    ...
    <div style="font-size:13px;line-height:1.45;margin-bottom:10px;">
      <b>Cashback lvl 8</b><br>
      Процент начисления: <b>13%</b> — от любой суммы чистого проигрыша<br>
      Вейджер: <b>x3</b><br>
      Ограничение по максимальному выигрышу: <b>x7</b>
    </div>
    ...
    <div style="font-size:13px;line-height:1.45;margin-bottom:10px;">
      <b>Cashback lvl 9</b><br>
      Процент начисления: <b>14%</b> — от любой суммы чистого проигрыша<br>
      Вейджер: <b>x3</b><br>
      Ограничение по максимальному выигрышу: <b>x7</b>
    </div>
    ...
    <div style="font-size:13px;line-height:1.45;">
      <b>Cashback lvl 10</b><br>
      Процент начисления: <b>20%</b> — от любой суммы чистого проигрыша<br>
      Вейджер: <b>x3</b><br>
      Ограничение по максимальному выигрышу: <b>x7</b>
    </div>
  </div>
  ...
  <footer style="margin-top:12px;font-size:13px;color:#475569;">
    <b>Примечание:</b> "От любой суммы чистого проигрыша" означает, что минимального порога проигрыша для начисления кешбека в уровнях 6–10 нет.
  </footer>
</section>
      🔗 <a href="https://confluence.itdepcat.tech/display/SUPDEP/CashBack+Kometa" target="_blank">Подробнее → Kometa</a>
            `
        };

        const html = infoMap[name];
        if (html) addCashbackBlock(html, `cb-${name}`);
    }
    function init() {
